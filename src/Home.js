...
const Home = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="w-auto flex  bg-gray-200 max-w-lg">
        <div class="flex flex-row h-screen">
  <div class="flex-none w-48 py-8 bg-white-shadow">
...
</div>  <div class="flex-1 bg-gray-200 px-4">
